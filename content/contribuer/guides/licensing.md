...
| [Beerware](/toc_nav_ignored/snippets/licenses/beerware/) | Licence humoristique autorisant toute réutilisation sans conditions mais qui l'invite à payer un coup à l'auteur/e original/e s'il/elle le rencontre. | {% raw %}`{% include "licenses/beerware.md" %}`{% endraw %} |
